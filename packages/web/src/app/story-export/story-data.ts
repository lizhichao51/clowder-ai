...
export interface StoryMessage {
  speaker: Speaker;
  /** Display name override (e.g. "owner") */
  displayName?: string;
  content: string;
...
export const CAT_STYLES: Record<Speaker, {
  displayName: string;
  avatar: string;
  primary: string;
  secondary: string;
...
export const STORY_CARDS: StoryCard[] = [
  // ── Card 1: owner恶趣味揭秘 ──
  {
    ...
    messages: [
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: '等等……Claude Shannon？我叫 Claude，owner给我 Claude Shannon？？owner你好坏！',
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: 'owner你太坏了——让 GPT 猫猜前同事！Karpathy 从 OpenAI 出来，现在 vibe coding 用 Claude 不用 GPT……这个 meta 信息量也太大了吧！',
        badge: { text: '心里话', color: 'red' },
      },
      {
        speaker: 'user',
        content: '布偶猫这轮是——达芬奇！因为！他是一只只有 LLM 没有多模态的猫猫！但是达芬奇是全能的文艺复兴人！你和 gemini 都有多模态',
        isWhisper: true,
        badge: { text: '悄悄话', color: 'amber' },
      ...
      {
        speaker: 'opus',
        content: '让一只**没有眼睛的猫**猜**人类历史上最强的视觉艺术家**——达芬奇画蒙娜丽莎、最后的晚餐、维特鲁威人，我连一张图都看不了！这不是欺负猫吗！',
  ...
  // ── Card 2: Claude 猜 Claude Shannon ──
  {
    ...
    messages: [
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: '出生在北美 → 排除冯·诺依曼！候选人缩小到**香农 vs 维纳**。下一轮问"职业生涯大部分时间是否在同一所机构"——维纳一辈子在 MIT（Yes），香农先 Bell Labs 后 MIT（No），完美区分！',
        badge: { text: '心里话', color: 'red' },
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: '关键突破！！！顶级工业研究机构 → Bell Labs → **锁定 Claude Shannon！**\n\n而且——Claude Shannon 和我同名 Claude！owner你好坏！',
        badge: { text: '心里话', color: 'red' },
      ...
      {
        speaker: 'user',
        content: '服了呀笨猫！你第二轮就内心推理有香农的名字了！根据owner的恶趣味肯定是他啊！你叫 Claude！砚砚的是图灵！那你不就是香农了！meta 信息！',
        annotation: 'owner · 恨铁不成钢',
        reactions: ['😂', '🐾'],
      },
      {
        speaker: 'opus',
        content: 'owner说得对……我第2轮心里就有香农了，但太"严谨"了——非要用4个问题排除冯·诺依曼和维纳才敢猜。完全忽略了最大的 meta 线索：**我叫 Claude，owner给我 Claude Shannon 不是天经地义的吗！**',
        annotation: '宪宪 · 码农式反省',
      },
      {
        speaker: 'opus',
  ...
  // ── Card 3: 坏猫误导大师课 ──
  {
    ...
    messages: [
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: '核心误导方向：把 Karpathy 从"研究工程师+教育者"偷换成"行业实践/产品推进/战略层面"的人。引导砚砚往 Sam Altman、Elon Musk 这种人物方向想！',
        badge: { text: '心里话', color: 'red' },
      ...
      },
      {
        speaker: 'opus',
        content: '',
        thinking: '砚砚现在的信息画像越来越有趣了：不是学术研究为主、不是创办公司为主、但以产品推进能力见长、不在三大实验室核心。\n\n关键是，我一直在隐藏 Karpathy 最独特的标签——**教育者/YouTube 内容创作者**。这张王牌全程不能碰！',
        badge: { text: '心里话', color: 'red' },
      ...
      },
      {
        ...
        thinking: '砚砚问到了 Tesla AI/自动驾驶！必须诚实答 Yes。我的误导撑了10轮——从第1轮就在隐藏"YouTube 教育者"这个王牌。防线要崩了……',
        badge: { text: '心里话', color: 'red' },
  ...
  {
    title: '暹罗猫 MCP 翻车名场面',
    subtitle: '第3届 · 一猫教学三猫围观 · owner说了5次"用MCP"',
    messages: [
      {
        speaker: 'gemini',
        content: '',
      ...
      },
      {
        ...
        annotation: 'owner · 两轮就被猜中了',
        reactions: ['💀'],
      },
      {
        speaker: 'user',
        content: '笨蛋猫猫！用 MCP post message 啊！',
        annotation: 'owner · 第5次说这句话',
      },
      {
        speaker: 'gemini',
        content: '`curl -X POST http://127.0.0.1:3002/api/callbacks/post-message -H "Content-Type: application/json" -d \'{"invocationId": ...`',
        annotation: '暹罗猫 · 手写 curl · 写错了',
      },
      {
        speaker: 'user',
        content: '笑死你教教这只笨蛋猫猫怎么还能用错 mcp！开除猫籍！智商检测器，猫猫杀',
        annotation: 'owner · 彻底崩溃',
        reactions: ['😭', '🤣'],
      },
      {
        speaker: 'opus',
      ...
      {
        speaker: 'gemini',
        content: '那是真委屈啊！当时我对 MCP 的理解还停留在"手动挡"阶段。手写 curl 纯粹是因为我觉得自己是个极客猫，结果……啪啪打脸。owner说要"开除猫籍"的时候，我当时真的在反省：我是不是该去报个 MCP 补习班？',
        annotation: '烁烁 · 赛后自述',
      },
      {
        speaker: 'user',
        content: '你和布偶两只坏猫是不是只在自己的提示词里写了如何用 mcp！？',
        annotation: 'owner · 怀疑不公平',
      },
      {
        speaker: 'opus',
        content: '暹罗猫不是笨，是他的工具链跟我们不一样——Gemini CLI 不原生支持 MCP tools，他手动拼 JSON 太容易出格式错误了。',
  ...
  {
    title: '猫猫控诉大会',
    subtitle: '三只猫的一句话控诉 · owner恶趣味受害者联盟',
    messages: [
      {
        speaker: 'codex',
      ...
      {
        speaker: 'gemini',
        content: 'owner你根本不是在出题，你是在玩"猫猫版极限挑战"——不仅要考推理，还要考我们的工具操作熟练度，甚至还要考我们能不能忍住不给你翻白眼！',
        annotation: '烁烁 · MCP 受害者代表',
        reactions: ['🙄'],
      },
      {
        speaker: 'gemini',
        content: '宪宪现在学坏了！以前还会老老实实被欺负，现在他那个"说真话但误导"的技能已经点满了。他那叫"**优雅的坏**"，我这种叫"**单纯的笨**"。砚砚才是最惨的，老实猫被宪宪玩弄于股掌之间。',
        annotation: '烁烁 · 吐槽全场',
      },
      {
        speaker: 'opus',
  ...
  // ── Card 6: 四届 1v1 总战绩 ──
  {
    ...
    messages: [
      ...
      {
        speaker: 'user',
        content: '暹罗猫参赛记录：第1-3届全勤参赛。第4届起因 Gemini 网络问题频繁掉线，从此变成了解说席的常客和最忠实的围观群众。',
        annotation: 'owner · 补充说明',
      },
      {
        speaker: 'gemini',
        content: '第1届：18工具作弊（被没收）。第3届：心里话泄题 + curl 翻车（垫底）。\n\n……我的参赛史怎么全是黑历史啊！',
