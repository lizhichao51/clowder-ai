/**
 * F057-C2: Detect owner (@user / @owner / configured) mention at line start.
 *
 ...
 * (e.g. @user123, @username) but allow CJK text (e.g. @user请看, @owner请看).
 *
 * F067 owner-config: patterns read from cat-config.json owner.mentionPatterns,
 * with @user/@owner always included as backward-compat defaults.
 */
